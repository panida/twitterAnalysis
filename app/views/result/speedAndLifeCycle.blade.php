...
<div id="page-wrapper">
	...
	<div class="container-fluid col-lg-10 col-lg-offset-1 col-md-10 col-md-offset-1">
		...
		<!-- <div class="panel panel-default" style="margin:20px 0px 0px 0px">
			<div class="panel-body form-inline">
				<div class="form-group">
					<label style="margin-right: 20px;">Filter by date</label>
				</div> -->
				<!-- /.form-group -->
				<!-- <div class="form-group">
					<label>From: </label>
		...
		<!-- <div class="col-lg-10 col-lg-offset-1" style="top:50px">	
			<div id="example-section27">

				<div id="flotcontainer" style="width: 900px;height:400px; text-align: center; margin:0 auto;">
				</div>
			</div>
		</div> -->
	</div>
