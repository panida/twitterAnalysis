			...
			<div class="panel-body">
				...
				<div style="position:relative">
					...
					<input type="text" class = "datepickerGraphStartdate" 
	                		style = 'left:778px; top:72px; position:absolute; float:left;  width: 95px; height:22px; font-size:12px; font-family:"Lucida Grande", "Lucida Sans Unicode", Arial, Helvetica, sans-serif;' />
	                <input type="text" class = "datepickerGraphEnddate" 
	                		style = 'left:906px; top:72px; position:absolute; float:left;  width: 95px; height:22px; font-size:12px; font-family:"Lucida Grande", "Lucida Sans Unicode", Arial, Helvetica, sans-serif;' />
				</div>
				<div style="position:relative">
